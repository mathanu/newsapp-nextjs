...
const BreakingNews = () => {
    ...
    return <div className="md:p-1 md:border-b md:border-gray-400 md:flex md:scroll-auto md:motion-safe:overflow-x-hidden mt-2 md:mt-12" >
    ...
    <div className="md:bg-yellow-400 md:p-2 md:mb-0 font-bold invisible sm:visible md:visible lg:visible"><h1>BREAKING NEWS </h1></div>
