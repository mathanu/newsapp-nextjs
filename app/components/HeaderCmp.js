...
const HeaderCmp = () => {
    return <div className="w-full z-20 md:h-12 md:flex md:justify-between fixed top-0 bg-white md:border-b md:border-gray-400 h-9 border-b border-gray-400">
    <div className="m-4 -mt-1 md:mx-12 md:p-2 h-full w-full">
    <Link href="/">
    <img src="https://i.ibb.co/0JmSXKs/ed1ef1058adf.jpg" alt="ed1ef1058adf" border="0" className=" mt-1 md:mt-0 w-10" /></Link>
    </div>
    ...
    <div className="visible -mt-[166px] z-20 bg-white p-2 m-2 overflow-x-hidden sm:invisible md:invisible lg:invisible border-b border-gray-400">
        <ul className="flex ">
    ...
    <div className="md:p-1 md:-mt-0  flex -mt-[71px] justify-end">
