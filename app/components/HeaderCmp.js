...
const HeaderCmp = () => {
    ...
    <Link href="/">
    <img src="https://i.ibb.co/VT0gnCb/Whats-App-Image-2023-11-14-at-9-43-18-PM.jpg" alt="logo" className="md:h-12 md:w-24 h-8 mt-1 md:mt-0 w-10" border="0" /></Link>
    </div>
    ...
    <div className="md:p-1 md:-mt-0 flex -mt-[78px] justify-end">
